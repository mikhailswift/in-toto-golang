...
in environment variables or config files. See Config docs for details.`,
	...
	recordCmd.PersistentFlags().StringVar(
		...
		"spire-socket",
		"",
		`Path to a SPIRE Workload API socket.  In-toto will attempt
to acquire a X509 SVID from SPIRE. If successful this SVID will
be used to sign metadata generated during record.`,
	)
